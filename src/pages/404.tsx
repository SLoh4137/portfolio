...
export default function NotFoundPage(props: NotFoundPageProps) {
    ...
    return (
        <>
            <Heading size={1} textAlign="center">Oops sorry that page doesn't exist!</Heading>
            <Heading size={2} textAlign="center">Here's a funny sign I found while biking instead</Heading>
